...
const NavBar = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full max-w-full mx-auto py-3 px-3 sm:px-4">
        {/* Logo */}
        <img
          src="/logo-1.png"
          alt="Studio 101 Logo"
        ...
        <button
          ...
          className="Toggle w-16 h-10 px-1.5 bg-indigo-500 rounded-3xl flex items-center relative overflow-hidden"
        >
          {/* Moving Circle */}
          <div
            className="Icon w-8 h-8 bg-white rounded-full flex justify-center items-center absolute transition-transform duration-[2s] ease-in-out"
            style={{
